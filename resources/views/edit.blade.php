        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <input type="hidden" class="url" value="{{url('/students/'.$student->id)}}" >
                        <input type="hidden" class="rdt-url" value="{{url('/students')}}" >
                        <form id="update_student" class="form-horizontal" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
